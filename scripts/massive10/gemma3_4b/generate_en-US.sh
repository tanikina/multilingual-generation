...
--language=en-US \
--input_path=data/de-massive/en-US_train.csv \
--output_path=data/generated/massive10/gemma3_4b/en-US_summarized_intent_with_10_english_demos \
--dataset=massive10 \
--model_name=google/gemma-3-4b-it \
--num_samples_to_generate=100 \
--num_input_demos=10 \
...
--language=en-US \
--input_path=data/de-massive/en-US_train.csv \
--output_path=data/generated/massive10/gemma3_4b/en-US_summarized_intent_with_10_target_lang_demos_and_revision \
--dataset=massive10 \
--model_name=google/gemma-3-4b-it \
--num_samples_to_generate=100 \
--num_input_demos=10 \
