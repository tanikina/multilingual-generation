...
--language=en-US \
--input_path=data/de-massive/en-US_train.csv \
--output_path=data/generated/massive10/llama3_8b/en-US_summarized_intent_with_10_english_demos \
--dataset=massive10 \
--model_name=TechxGenus/Meta-Llama-3-8B-Instruct-GPTQ \
--num_samples_to_generate=100 \
--num_input_demos=10 \
...
--language=en-US \
--input_path=data/de-massive/en-US_train.csv \
--output_path=data/generated/massive10/llama3_8b/en-US_summarized_intent_with_10_target_lang_demos_and_revision \
--dataset=massive10 \
--model_name=TechxGenus/Meta-Llama-3-8B-Instruct-GPTQ \
--num_samples_to_generate=100 \
--num_input_demos=10 \
