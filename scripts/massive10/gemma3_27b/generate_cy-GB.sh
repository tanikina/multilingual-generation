...
--language=cy-GB \
--input_path=data/cy-massive/cy-GB_train.csv \
--output_path=data/generated/massive10/gemma3_27b/cy-GB_summarized_intent_with_10_english_demos.csv \
--dataset=massive10 \
--model_name=google/gemma-3-27b-it \
--num_samples_to_generate=100 \
--num_input_demos=10 \
...
--language=cy-GB \
--input_path=data/cy-massive/cy-GB_train.csv \
--output_path=data/generated/massive10/gemma3_27b/cy-GB_summarized_intent_with_10_target_lang_demos_and_revision.csv \
--dataset=massive10 \
--model_name=google/gemma-3-27b-it \
--num_samples_to_generate=100 \
--num_input_demos=10 \
