...
--output_path=data/generated/massive10/gemma3_27b/sw-KE_only_summarized_intent.csv \
--dataset=massive10 \
...
--language=sw-KE \
--input_path=data/sw-massive/sw-KE_train.csv \
--output_path=data/generated/massive10/gemma3_27b/sw-KE_summarized_intent_with_10_target_lang_demos.csv \
--dataset=massive10 \
--model_name=google/gemma-3-27b-it \
--num_samples_to_generate=100 \
--num_input_demos=10 \
