...
for seed in ${seeds[@]}; do
    ...
    --eval_results_file="results/massive10/gemma3_27b/id_results.csv"
done
for seed in ${seeds[@]}; do
    python src/train_roberta.py \
    --seed=$seed \
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_27b/id-ID_only_summarized_intent.csv" \
    --test_data_path="data/id-massive/id-ID_test.csv" \
    --eval_results_file="results/massive10/gemma3_27b/id_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_27b/id-ID_summarized_intent_with_10_target_lang_demos.csv" \
    --test_data_path="data/id-massive/id-ID_test.csv" \
    --eval_results_file="results/massive10/gemma3_27b/id_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_27b/id-ID_summarized_intent_with_10_english_demos.csv" \
    --test_data_path="data/id-massive/id-ID_test.csv" \
    --eval_results_file="results/massive10/gemma3_27b/id_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_27b/id-ID_summarized_intent_with_10_target_lang_demos_and_revision.csv" \
    --test_data_path="data/id-massive/id-ID_test.csv" \
    --eval_results_file="results/massive10/gemma3_27b/id_results.csv"
done
