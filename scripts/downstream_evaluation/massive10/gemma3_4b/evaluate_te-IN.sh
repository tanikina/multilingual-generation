...
for seed in ${seeds[@]}; do
    ...
    --eval_results_file="results/massive10/gemma3_4b/te_results.csv"
done
for seed in ${seeds[@]}; do
    python src/train_roberta.py \
    --seed=$seed \
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_4b/te-IN_only_summarized_intent.csv" \
    --test_data_path="data/te-massive/te-IN_test.csv" \
    --eval_results_file="results/massive10/gemma3_4b/te_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_4b/te-IN_summarized_intent_with_10_target_lang_demos.csv" \
    --test_data_path="data/te-massive/te-IN_test.csv" \
    --eval_results_file="results/massive10/gemma3_4b/te_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_4b/te-IN_summarized_intent_with_10_english_demos.csv" \
    --test_data_path="data/te-massive/te-IN_test.csv" \
    --eval_results_file="results/massive10/gemma3_4b/te_results.csv"
done
for seed in ${seeds[@]}; do
    ...
    --balanced \
    --normalized \
    --train_data_path="data/generated/massive10/gemma3_4b/te-IN_summarized_intent_with_10_target_lang_demos_and_revision.csv" \
    --test_data_path="data/te-massive/te-IN_test.csv" \
    --eval_results_file="results/massive10/gemma3_4b/te_results.csv"
done
